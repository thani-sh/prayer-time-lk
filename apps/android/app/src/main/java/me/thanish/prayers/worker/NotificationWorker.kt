...
import me.thanish.prayers.widget.nextprayer.hasActiveWidgets
import me.thanish.prayers.widget.nextprayer.updateAllWidgets
...
class NotificationWorker : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val ACTION_MINUTE_TICK = "me.thanish.prayers.MINUTE_TICK"
